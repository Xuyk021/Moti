...
import moti_setting_config_meta as MSC
...
if st.session_state.chat_disabled and st.session_state.answered:
    ...
    if (
        ...
        or
        (MSC.THINKING_MOTI and st.session_state.moti_shown and not st.session_state.verify_shown and st.session_state.feedback_submitted)
    ):
