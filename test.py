...
import moti_setting_config_copy as MSC
...
def show_thinking_intro():
    ...
    st.image("AI-thinking-mode_1.gif", use_container_width=True,caption="Use the toggle switch below the search bar to enable AI Thinking mode.")
